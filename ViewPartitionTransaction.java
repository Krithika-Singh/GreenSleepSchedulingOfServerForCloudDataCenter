...
public class ViewPartitionTransaction extends JFrame implements ActionListener
{
...
JLabel imglabel;
ViewPartitionTransaction(Vector data) 
 {

setTitle("Partition Transaction :: GREEN SLEEP SCHEDULING OF SERVERS FOR CLOUD DATA CENTER");
c= getContentPane();
c.setLayout (null);
