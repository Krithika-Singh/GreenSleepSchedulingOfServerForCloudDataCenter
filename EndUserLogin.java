...
EndUserLogin()
  {
	  jf = new JFrame("USER LOGIN :: GREEN SLEEP SCHEDULING OF SERVERS FOR CLOUD DATA CENTER");
	  c = jf.getContentPane();
	  c.setLayout(null);
	  c.setBackground(new Color(223, 159, 191));
          
          a3 = new JLabel("User Login");
          a3.setFont(new Font("Times new roman", Font.BOLD, 18));
          a3.setBounds(130,4,200,80);
	  c.add(a3);
