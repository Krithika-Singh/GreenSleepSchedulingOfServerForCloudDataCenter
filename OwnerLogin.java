...
public class OwnerLogin extends JFrame implements ActionListener
{
	...
	OwnerLogin()
	{
		...
		c = getContentPane();
		c.setLayout(null);
		//c.setBackground(new Color(241,70,61));
                c.setBackground(new Color(223, 159, 191));
		setTitle("DATA OWNER LOGIN :: GREEN SLEEP SCHEDULING OF SERVERS FOR CLOUD DATA CENTER");
		...
		if(e.getSource()==j2)
		{
			String name = t1.getText();
			  ...
			  try
			  {
				  ...
				  {
					  JOptionPane.showMessageDialog(null,"Hi "+ name + " You have Logged in Successfully");
					  new DataOwner(name);
					  
				  }
				  else 
				  {
					  JOptionPane.showMessageDialog(null, "Hi " + name + " You are not a Valid User");
				  }
