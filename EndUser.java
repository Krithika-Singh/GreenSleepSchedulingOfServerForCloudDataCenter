...
public class EndUser implements ActionListener 
{
	...
	EndUser(String name)
	{
		jf = new JFrame("END USER :: GREEN SLEEP SCHEDULING OF SERVERS FOR CLOUD DATA CENTER");
		c = jf.getContentPane();
		c.setLayout(null);
	...
	jf.setMenuBar(mbr);*/
		...
		logout.setBounds(50, 350, 100, 30);
			...
			else
			{
				String[] dsn = { "Select", "CS1", "CS2", "CS3"};
				 ...
				 keyw = (String) JOptionPane.showInputDialog(null,
						"In which cloud server is file present ?", " CloudServer",
						  ...
						  if(msg.equalsIgnoreCase("success"))
							{
								...
								FileOutputStream fos = new FileOutputStream("C:\\Users\\HOME\\OneDrive\\Desktop\\major\\src\\EndUser\\"+ file);
